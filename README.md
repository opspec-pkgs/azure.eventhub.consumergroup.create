...
```shell
opctl pkg install github.com/opspec-pkgs/azure.eventhub.consumergroup.create#1.0.0
```

## Run

```
opctl run github.com/opspec-pkgs/azure.eventhub.consumergroup.create#1.0.0
```
...
```yaml
op:
  pkg: { ref: github.com/opspec-pkgs/azure.eventhub.consumergroup.create#1.0.0 }
  inputs:
    subscriptionId:
    loginId:
    loginSecret:
